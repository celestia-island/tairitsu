...
fn prev_arrow() -> VNode {
    svg_icon(MdiIcon::ChevronLeft, 14, "")
}

fn next_arrow() -> VNode {
    svg_icon(MdiIcon::ChevronRight, 14, "")
}
                ...
                div { class: "demo-block",
                    ...
                    div { class: "demo-block__body",
                        nav { class: "hi-pagination",
                            a { href: "#", class: "hi-pagination-prev", ..vec![prev_arrow()] }
                            ...
                            a { href: "#", class: "hi-pagination-next", ..vec![next_arrow()] }
                        }
                    }
                }
                div { class: "demo-block",
                ...
                div { class: "demo-block",
                    ...
                    div { class: "demo-block__body",
                        div { style: "display:flex;flex-direction:column;gap:12px;",
                            nav { class: "hi-pagination hi-pagination-mini",
                                a { href: "#", class: "hi-pagination-prev", ..vec![prev_arrow()] }
                                a { href: "#", class: "hi-pagination-item hi-pagination-active", "1" }
                                a { href: "#", class: "hi-pagination-item", "2" }
                                a { href: "#", class: "hi-pagination-item", "3" }
                ...
                div { class: "demo-block",
                    ...
                    div { class: "demo-block__body",
                        table { class: "api-table",
                            ...
                            tbody {
                                 tr { td { code { "current" } } td { code { "number" } } td { "Current page number" } }
                                tr { td { code { "total" } } td { code { "number" } } td { "Total items count" } }
                                tr { td { code { "pageSize" } } td { code { "number" } } td { "Items per page" } }
                                tr { td { code { "showSizeChanger" } } td { code { "bool" } } td { "Show page size selector" } }
                                tr { td { code { "showQuickJumper" } } td { code { "bool" } } td { "Show quick jump input" } }
                                tr { td { code { "onChange" } } td { code { "(page: number) => void" } } td { "Page change callback" } }
                            }
                        }
                    }
                }
