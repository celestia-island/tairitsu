 ...
 *
 * Auto-generated from: /mnt/sdb1/tairitsu/packages/browser-worlds/wit/generated/resize-observer.wit
 ...
 * `observe()` operation.
 */
export function observe(handle: bigint, target: bigint, options: string | undefined): void {
