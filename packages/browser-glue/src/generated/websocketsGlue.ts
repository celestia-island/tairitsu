 ...
 * `connect()` operation.
 */
export function connect(url: string, protocols: string): { ok: true; value: string } | { ok: false; error: bigint } {
 ...
 */
export function extensions(handle: bigint): EventHandlerRecord {
  const obj = lookupWs(handle);
