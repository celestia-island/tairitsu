 ...
 */
export function getTrackVisibility(self: bigint): number {
  const obj = getIntersectionObserver(self);
 ...
 * `observe()` operation.
 */
export function observe(self: bigint, target: number): void {
  const obj = getIntersectionObserver(self);
  obj.observe(target);
}
...
/** Type alias */
export type ResizeObserverEntryHandle = boolean;
 ...
 */
export function getContentRect(self: number): bigint {
  const obj = getResizeObserverEntry(self);
 ...
 */
export function getContentBoxSize(self: bigint): boolean {
  const obj = getResizeObserverEntry(self);
