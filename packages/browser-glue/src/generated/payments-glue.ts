 ...
 * `show()` operation.
 */
export function show(self: bigint, detailsPromise: bigint): bigint | undefined {
 ...
 */
export function abort(self: string): bigint {
 ...
 * `complete()` operation.
 */
export function complete(self: bigint, result: bigint | undefined, details: bigint | undefined): number {
  const obj = getPaymentResponse(self);
 ...
 */
export function getMethodDetails(self: boolean | undefined): boolean {
  const obj = getPaymentMethodChangeEvent(self);
...
/** Type alias */
export type PaymentRequestUpdateEventHandle = number;
 ...
 */
export function updateWith(self: number, detailsPromise: bigint): void {
