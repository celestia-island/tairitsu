 ...
 * `grow()` operation.
 */
export function grow(self: bigint, delta: bigint): string {
 ...
 */
export function toFixedLengthBuffer(self: number): (string)[] {
  const obj = getMemory(self);
 ...
 */
export function toResizableBuffer(self: string): bigint {
  const obj = getMemory(self);
 ...
 * `grow()` operation.
 */
export function grow(self: bigint, delta: bigint, value: string | undefined): string {
 ...
 * `get()` operation.
 */
export function _get(self: bigint, index: string | undefined): string {
  const obj = getTable(self);
 ...
 * `set()` operation.
 */
export function _set(self: (string)[], index: bigint, value: string | undefined): void {
  const obj = getTable(self);
 ...
 * `value-of()` operation.
 */
export function valueOf(self: string): bigint {
