 ...
 * `show()` operation.
 */
export function show(self: bigint, detailsPromise: EventHandlerRecord | undefined): EventHandlerRecord {
 ...
 * `get-shipping-address()` operation.
 */
export function PaymentResponseGetShippingAddress(self: bigint): string | undefined {
  const obj = getPaymentResponse(self);
  return obj.shippingAddress ?? undefined;
}
 ...
 * `retry()` operation.
 */
export function retry(self: bigint, errorFields: number | undefined): bigint {
  const obj = getPaymentResponse(self);
