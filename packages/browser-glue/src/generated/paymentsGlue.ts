 ...
 * `show()` operation.
 */
export function show(self: bigint, detailsPromise: bigint): string {
 ...
 * `complete()` operation.
 */
export function complete(self: bigint, result: string | undefined, details: bigint | undefined): string {
  const obj = getPaymentResponse(self);
