 ...
 * `get-id()` operation.
 */
export function MediaStreamGetId(self: bigint): boolean {
 ...
 */
export function getTrackById(self: bigint, trackId: bigint): bigint | undefined {
  const obj = getMediaStream(self);
 ...
 */
export function getConstraints(self: bigint): string {
  const obj = getMediaStreamTrack(self);
 ...
 */
export function getUserMedia(self: bigint, constraints: string | undefined): boolean {
  const obj = getMediaDevices(self);
  return obj.getUserMedia;
}
 ...
 */
export function setCameraActive(self: bigint, active: boolean): number {
  const obj = getMediaSession(self);
 ...
 * `get-title()` operation.
 */
export function MediaMetadataGetTitle(self: bigint): boolean {
 ...
 * `get-title()` operation.
 */
export function ChapterInformationGetTitle(self: bigint): boolean {
 ...
 */
export function getContinuous(self: bigint): number {
  const obj = getSpeechRecognition(self);
