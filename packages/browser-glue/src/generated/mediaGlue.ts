 ...
 */
export function getOnstart(self: bigint): bigint {
  const obj = getMediaRecorder(self);
  return obj.onstart;
}
 ...
 */
export function setOnstart(self: bigint, value: bigint): void {
  const obj = getMediaRecorder(self);
  obj.onstart = value;
}
 ...
 */
export function getOnresume(self: bigint): bigint {
  const obj = getMediaRecorder(self);
  return obj.onresume;
}
 ...
 */
export function setOnresume(self: bigint, value: bigint): void {
  const obj = getMediaRecorder(self);
  obj.onresume = value;
}
 ...
 * `start()` operation.
 */
export function start(self: bigint, timeslice: number | undefined): void {
  const obj = getMediaRecorder(self);
  obj.start(timeslice);
}
 ...
 * `resume()` operation.
 */
export function resume(self: bigint): void {
  const obj = getMediaRecorder(self);
  obj.resume();
}
 ...
 * `get-onend()` operation.
 */
export function getOnend(self: bigint): bigint {
  const obj = getSpeechRecognition(self);
  return obj.onend;
}
 ...
 * `set-onend()` operation.
 */
export function setOnend(self: bigint, value: bigint): void {
  const obj = getSpeechRecognition(self);
  obj.onend = value;
}
