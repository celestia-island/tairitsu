 ...
 */
export function randomUuid(self: number): string {
  const obj = getCrypto(self);
 ...
 * `verify()` operation.
 */
export function verify(self: bigint, algorithm: bigint, key: bigint, signature: number, data: (bigint)[]): bigint {
  const obj = getSubtleCrypto(self);
 ...
 */
export function deriveKey(self: bigint, algorithm: bigint | undefined, baseKey: bigint, derivedKeyType: bigint, extractable: bigint | undefined, keyUsages: bigint): bigint {
  const obj = getSubtleCrypto(self);
 ...
 */
export function deriveBits(self: bigint, algorithm: bigint, baseKey: boolean, length: bigint): bigint {
  const obj = getSubtleCrypto(self);
 ...
 */
export function unwrapKey(self: bigint, format: bigint, wrappedKey: Uint8Array, unwrappingKey: bigint, unwrapAlgorithm: bigint | undefined, unwrappedKeyAlgorithm: bigint, extractable: boolean, keyUsages: (bigint)[]): bigint {
  const obj = getSubtleCrypto(self);
