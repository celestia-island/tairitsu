 ...
 */
export function getAlgorithm(self: bigint): string {
  const obj = getCryptoKey(self);
 ...
 * `wrap-key()` operation.
 */
export function wrapKey(self: bigint, format: bigint, key: bigint, wrappingKey: bigint, wrapAlgorithm: (string)[] | undefined): bigint {
  const obj = getSubtleCrypto(self);
 ...
 */
export function unwrapKey(self: bigint, format: bigint, wrappedKey: (bigint)[], unwrappingKey: bigint, unwrapAlgorithm: string, unwrappedKeyAlgorithm: bigint, extractable: bigint, keyUsages: (bigint)[]): bigint {
  const obj = getSubtleCrypto(self);
