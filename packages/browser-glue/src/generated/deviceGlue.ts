 ...
 */
export function playEffect(self: bigint, type: string, params: string | undefined): bigint {
 ...
 * `to-json()` operation.
 */
export function GeolocationPositionToJson(self: bigint): number | undefined {
  const obj = lookupGeolocationPosition(self);
  return obj.toJSON();
}
