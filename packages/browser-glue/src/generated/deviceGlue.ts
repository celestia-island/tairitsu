 ...
 */
export function getClipboard(): number {
 ...
 * `vibrate()` operation.
 */
export function vibrate(pattern: bigint): boolean {
 ...
 */
export function GamepadEventGetGamepad(self: bigint): string {
 ...
 */
export function getOnafterprint(self: bigint): string | undefined {
  const obj = getWindowEventrs(self);
 ...
 */
export function getHeading(self: bigint): string {
  const obj = getGeolocationCoordinates(self);
