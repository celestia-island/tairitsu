 ...
 */
export function customSections(moduleObject: number, sectionName: string): (string)[] {
 ...
 * `set()` operation.
 */
export function _set(self: bigint, index: bigint, value: EventHandlerRecord): void {
  const obj = lookupTable(self);
