...
/** Type alias */
export type AbstractRangeHandle = string;
 ...
 */
export function getStartOffset(self: string): number {
  const obj = getAbstractRange(self);
 ...
 * `get-root()` operation.
 */
export function getRoot(self: bigint | undefined): bigint {
 ...
 */
export function getCurrentNode(self: bigint | undefined): bigint | undefined {
  const obj = getTreeWalker(self);
 ...
 */
export function parentNode(self: bigint | undefined): bigint | undefined | undefined {
  const obj = getTreeWalker(self);
  return obj.parentNode() ?? undefined;
}
 ...
 */
export function firstChild(self: bigint): bigint {
  const obj = getTreeWalker(self);
  return obj.firstChild() ?? undefined;
}
 ...
 */
export function nextSibling(self: bigint): Uint8Array {
  const obj = getTreeWalker(self);
  return obj.nextSibling() ?? undefined;
}
