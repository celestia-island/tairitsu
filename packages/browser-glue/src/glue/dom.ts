 ...
 */
export function addEventListener(self: bigint, type: string, callback: bigint | undefined, options: boolean | undefined): void {
 ...
 */
export function removeEventListener(self: bigint, type: string, callback: bigint | undefined, options: boolean | undefined): void {
  const obj = lookupEventTarget(self);
 ...
 * `prepend()` operation.
 */
export function prepend(self: bigint, nodes: (string)[]): void {
  const obj = lookupParentNode(self);
 ...
 * `append()` operation.
 */
export function append(self: bigint, nodes: (string)[]): void {
  const obj = lookupParentNode(self);
 ...
 */
export function replaceChildren(self: bigint, nodes: (string)[]): void {
  const obj = lookupParentNode(self);
 ...
 * `before()` operation.
 */
export function before(self: bigint, nodes: (string)[]): void {
 ...
 * `after()` operation.
 */
export function after(self: bigint, nodes: (string)[]): void {
  const obj = lookupChildNode(self);
 ...
 */
export function replaceWith(self: bigint, nodes: (string)[]): void {
  const obj = lookupChildNode(self);
