...
impl BrowserDownloader {
    ...
    fn get_download_url(&self, version: &str, platform: Platform) -> String {
        let base_url = self
            .mirror
            .as_deref()
            .unwrap_or("https://storage.googleapis.com/chrome-for-testing-public");
    ...
    fn extract_archive(
        ...
        let progress = ProgressBar::new(archive.len() as u64).with_style(
            ProgressStyle::default_bar()
                .template(
