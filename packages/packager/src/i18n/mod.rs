...
yuuka::derive_struct!(
    ...
    pub Translations {
        ...
        build: Build {
            ...
            step_bundle: String,
            step_wrapper: String,
            step_generate_html: String,
            creating_output_dir: String,
            copying_wasm: String,
            copying_glue: String,
            copying_public: String,
            compiling_scss: String,
            build_complete: String,
            package_info: String,
            initial_build_ok: String,
            ...
            unknown_build_target: String,
            target_not_installed: String,
            component_not_found: String,
            building_component: String,
            flattened_barrel: String,
            copying_extra_public: String,
            extra_public_not_found: String,
            scss_project_root: String,
            ...
            daemon_attach_hint: String,
            force_killing_daemon: String,
            status_ok: String,
            status_fail: String,
        },
        icons: Icons {
...
const ZHS_CLI: &str = include_str!("../../res/i18n/packager/zh-Hans/cli.toml");
const ZHS_DEV: &str = include_str!("../../res/i18n/packager/zh-Hans/dev.toml");
const ZHS_BUILD: &str = include_str!("../../res/i18n/packager/zh-Hans/build.toml");
const ZHS_ICONS: &str = include_str!("../../res/i18n/packager/zh-Hans/icons.toml");
const ZHT_CLI: &str = include_str!("../../res/i18n/packager/zh-Hant/cli.toml");
const ZHT_DEV: &str = include_str!("../../res/i18n/packager/zh-Hant/dev.toml");
const ZHT_BUILD: &str = include_str!("../../res/i18n/packager/zh-Hant/build.toml");
