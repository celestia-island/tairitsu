    ...
    T: Send,
{
    ...
    linker.func_wrap(
        ...
        move |_caller: wasmtime::Caller<'_, T>, _element: u64| -> Result<(f64, f64, f64, f64), wasmtime::Error> {
    ...
    linker.func_wrap(
        "tairitsu-browser:full/platform-helpers@0.2.0",
        "set-timeout",
        move |_caller: wasmtime::Caller<'_, T>, _callback_id: u64, _ms: i32| -> Result<i32, wasmtime::Error> {
    ...
    linker.func_wrap(
        "tairitsu-browser:full/platform-helpers@0.2.0",
        "clear-timeout",
        move |_caller: wasmtime::Caller<'_, T>, _id: i32| {
            Ok(())
        },
    )?;
    ...
    linker.func_wrap(
        ...
        move |_caller: wasmtime::Caller<'_, T>, _callback_id: u64| -> Result<u32, wasmtime::Error> {
            Ok(1)
        },
    )?;
    ...
    linker.func_wrap(
        ...
        move |_caller: wasmtime::Caller<'_, T>, _id: u32| {
            Ok(())
        },
    )?;
    ...
    linker.func_wrap(
        ...
        move |_caller: wasmtime::Caller<'_, T>, _callback_id: u64| -> Result<u64, wasmtime::Error> {
            Ok(1)
        },
    )?;
    ...
    linker.func_wrap(
        "tairitsu-browser:full/platform-helpers@0.2.0",
        "observe-resize",
        move |_caller: wasmtime::Caller<'_, T>, _observer: u64, _element: u64| {
            Ok(())
        },
    )?;
    ...
    linker.func_wrap(
        "tairitsu-browser:full/platform-helpers@0.2.0",
        "disconnect-resize",
        move |_caller: wasmtime::Caller<'_, T>, _observer: u64| {
            Ok(())
        },
    )?;
    ...
    linker.func_wrap(
        "tairitsu-browser:full/platform-helpers@0.2.0",
        "observe-mutations",
        move |_caller: wasmtime::Caller<'_, T>, _observer: u64, _element: u64, _options: Option<u64>| {
            Ok(())
        },
    )?;
