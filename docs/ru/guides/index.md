...
| Документ | Описание |
|:--|:--|
| [Руководство для начинающих](../../en/guides/getting-started.md) | От нуля до работающего полнофункционального приложения. Охватывает `tairitsu new`, первый компонент, серверный и клиентский запуск, развёртывание. |
...
| [VDOM и рендеринг](../../en/system/vdom.md) | Сравнение виртуального DOM, патчинг, система событий, реактивный планировщик |
