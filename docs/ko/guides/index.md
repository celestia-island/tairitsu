...
| 문서 | 설명 |
|:--|:--|
| [시작하기 튜토리얼](../../en/guides/getting-started.md) | 제로부터 풀스택 앱 구축. `tairitsu new`, 첫 컴포넌트, 서버 + 클라이언트 실행, 배포까지. |
...
| [VDOM & 렌더링](../../en/system/vdom.md) | 가상 DOM diffing, patching, 이벤트 시스템, 반응형 스케줄러 |
